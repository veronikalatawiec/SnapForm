    ...
    <div className="builder">
      <form onSubmit={handleSubmit} className="builder__form">
        <div className="builder__name">
          <label htmlFor="formName" className="builder__label">
            Form Name
          </label>
          <input
            id="formName"
            ...
            case "shorttext":
              return (
                <div key={index} className="builder__section">
                  <ShortText
                    onChange={(newSection) =>
                      handleSectionChange(index, newSection)
                    }
                    label={section.label}
        ...
        <div className="builder__add-sections">
          ...
          <Button
            ...
            className="btn--build"
            iconPosition="icon-top"
            icon={<img src={Paragraph} alt="P" />}
          />
          <Button
            type="button"
            onClick={() => addSection("shorttext")}
            text="Add Short Text Question"
            className="btn--build"
            iconPosition="icon-top"
            icon={<img src={Text} alt="T" />}
          />
          <Button
            type="button"
            onClick={() => addSection("longtext")}
            text="Add Long Text Question"
            className="btn--build"
            iconPosition="icon-top"
            icon={<img src={Text} alt="T" />}
          />
          <Button
            ...
            text="Add Checkbox Question"
            className="btn--build"
            iconPosition="icon-top"
            icon={<img src={MChoice} alt="M" />}
          />
          <Button
            type="button"
